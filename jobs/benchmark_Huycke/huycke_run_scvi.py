...
with timer:
    scvi_vae = ccd.ul.run_scvi(adata, batch_key="LaneID", output_key=output_key, return_model=True, n_latent=50, return_corrected=False, transform_batch=transform_batch)
