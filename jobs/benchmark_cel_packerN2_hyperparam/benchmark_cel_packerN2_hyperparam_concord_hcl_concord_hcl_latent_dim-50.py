...
CONFIG = {
    ...
    "CONCORD_SETTINGS": {
        "CONCORD_KWARGS": {'latent_dim': 50, 'batch_size': 64, 'encoder_dims': [1000], 'p_intra_domain': 1.0, 'p_intra_knn': 0.0, 'clr_beta': 1.0, 'augmentation_mask_prob': 0.3, 'clr_temperature': 0.3, 'sampler_knn': 1000, 'n_epochs': 14, 'lr': 0.01, 'save_dir': '../../save/cel_packerN2_hyperparam', 'output_key': 'concord_hcl_latent_dim-50'}
    }
}
