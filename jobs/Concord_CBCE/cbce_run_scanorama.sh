...
#$ -l h_rt=2:00:00   # Maximum run time (24 hours in this case)
#$ -l mem_free=64G    # Request memory (32GB here)
#$ -o scanorama_output.log      # Output file
#$ -e scanorama_error.log       # Error log file

current_time=$(date "+%Y%m%d-%H%M%S")
# Define log file names
script_name="cbce_run_scanorama"
