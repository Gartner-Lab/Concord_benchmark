...
with timer:
    scvi_vae = ccd.ul.run_scvi(adata, batch_key="dataset3", output_key=output_key, return_model=True, n_latent=300, return_corrected=False, transform_batch=transform_batch)
...
# Save the model
scvi_vae.save(save_dir / f"{output_key}_{file_suffix}")
