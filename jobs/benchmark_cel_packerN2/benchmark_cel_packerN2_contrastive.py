...
CONFIG = {
    ...
    "DATA_SETTINGS": {
        "ADATA_FILENAME": "cel_packerN2_preprocessed.h5ad",
        "BATCH_KEY": "batch",
        "STATE_KEY": "None",
        "COUNT_LAYER": "counts",
    },
    ...
    "CONCORD_SETTINGS": {
        "CONCORD_KWARGS": {'batch_size': 64, 'latent_dim': 300, 'encoder_dims': [1000], 'augmentation_mask_prob': 0.3, 'clr_temperature': 0.3, 'sampler_knn': 1000, 'n_epochs': 15, 'verbose': True, 'seed': 0, 'save_dir': '../../save/cel_packerN2'}
    }
}
